...
class ExerciseDetailActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val exerciseDescription =
            intent.getStringExtra("EXERCISE_DESCRIPTION") ?: "No description available"
        ...
        if (exerciseImage != 0) {
            ...
            imageView.setImageResource(R.drawable.warning) // Add a placeholder image in `res/drawable`
        }
    }
